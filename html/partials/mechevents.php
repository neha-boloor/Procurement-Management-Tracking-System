<article ng-controller="eventCtrl">
    <div class="container-fluid text-center" style="background:#e74c3c; padding-top: 100px; padding-bottom: 100px;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="pacifico white" style="text-shadow: 0 5px 5px #222;">Department of Mechnaical Engineering and Support</h1>
            </div>
        </div>
                ...
                <div class="event-card" style="padding:60px;">
                   ...
                   <!-- <p class="cuprum gray font30">
					...
					<p class="cuprum gray font30" style="text-align:left">
                     	<img src="images/m.png" style="float:right" width="380px" height="200px"/>
						Officers:
						                <ul style="text-align:left">
											<li>Mrs. Chandana N T</li>
											<li>Mr. Pratap</li>
											<li>Mrs. Rachita Gururaj</li>
											<li>Mr. Tushar Pandey</li>
										</ul>
