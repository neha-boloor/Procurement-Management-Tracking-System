...
<body>
  ...
  <hr>
  <div class="container bootstrap snippet" style="width:800px; height:950px;">
    <div class="row" style="width:800px; height:950px;">
      <div class="col-lg-12" style="width:800px; height:950px;">
        <div class="main-box no-header clearfix" style="width:800px; height:950px;">
          <div class="main-box-body clearfix" style="width:800px; height:950px;">
            <div class="table-responsive" style="width:800px; height:950px;">
                ...
                <table class="table user-list">
                  ...
                  <tbody>
                    <?php
                        ...
                        $cursor = $db->query("select * from user join authorisation on user.Auth_id = authorisation.Auth_id join department on user.Dept_id = department.Dept_id");
                        if ($db->error) {
