    ...
    <div class="row">
      <nav class="col-sm-3" id="myScrollspy" >
        <ul class="nav nav-pills nav-stacked" style="font-weight:900;">
          <li class="active"><a class="left" href="#section1">View Unassigned Requests</a></li>
      ...
      <div class="col-sm-9">
        <div id="section1">
          <h1 style="margin-left:20px;margin-top:30px;padding-top:30px;">View Unassigned Requests</h1>
